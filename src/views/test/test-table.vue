<template>
  <ContentTable>
    <template #menu>
      <div style="height: 200px; display: flex; align-items: center; justify-content: center">workbench-ddddddd</div>
    </template>
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column label="File" width="180" prop="zip" />
      <el-table-column label="Address" min-width="240" prop="address" />
